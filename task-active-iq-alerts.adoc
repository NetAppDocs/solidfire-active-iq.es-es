...
La página *Directivas* del menú desplegable *Alertas* en *All Clusters View* muestra la siguiente información de directiva para todos los clústeres.
...
En la página *clústeres suprimidos* del menú desplegable *Alertas* dentro de la *Vista todos los clústeres*, puede ver una lista de clústeres que tienen notificaciones de alerta suprimidas.
...
La siguiente información está disponible en la página *clústeres suprimidos*.
...
| Acciones | Seleccione la opción para suprimir o reanudar notificaciones para un clúster. 
|===
